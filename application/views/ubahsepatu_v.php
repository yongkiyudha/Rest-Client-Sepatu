...
<div class="content-wrapper">
        <section class="content-header">
           <center> <h2>FORM UBAH DATA SEPATU</h2> </center>
        </section>
        <br>
        </div>
    <div class="row mt-3">
        <div class="col-md-15">
            <div class="card">
                <div class="card-body">
                <form action="<?= base_url();?>Sepatu/ubah/<?=$sepatu['id_sepatu']?>" method="post">  
                <input type="hidden" name="id_sepatu" value="<?= $sepatu['id_sepatu']; ?> ">

                        <div class="form-group">
                            <label for="merk">Merk Sepatu</label>
                            <input type="text" name="merk" class="form-control" id="merk" value="<?= $sepatu['merk'] ?>" >
                        </div>
                        <div class="form-group">
                            <label for="dukuran">Ukuran Sepatu</label>
